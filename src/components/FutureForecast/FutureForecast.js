  ...
  return (
    <Card>
      <div className="relative">
        ...
        <h2 className="px-5 font-medium text-2xl pb-5 text-dark-100 dark:text-light-200 border-b-paragraph border-b-2">10 day forecast</h2>
            ...
            {futureForecast.map((item) => (
              <SwiperSlide key={item.date_epoch}>
                <FutureForecastItem 
                  ...
                  maxTempDeg={tempUnit === 'C' ? item.day.avgtemp_c : item.day.avgtemp_f} 
                  minTempDeg={tempUnit === 'C' ? item.day.avgtemp_c : item.day.avgtemp_f}
